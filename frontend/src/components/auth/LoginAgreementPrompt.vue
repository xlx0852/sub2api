<template>
  ...
  <Teleport to="body">
    <Transition name="agreement-fade">
      ...
      >
        <div class="w-full max-w-[600px] overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-black/10 dark:bg-dark-900 dark:ring-white/10">
          ...
          <div class="border-t border-gray-100 bg-gray-50/80 px-6 py-4 dark:border-dark-800 dark:bg-dark-950/60">
            <div class="grid grid-cols-2 gap-3">
              ...
              <button
                type="button"
                class="rounded-xl bg-primary-600 px-4 py-3 text-sm font-semibold text-white   transition hover:bg-primary-700"
                @click="emit('accept')"
              >
