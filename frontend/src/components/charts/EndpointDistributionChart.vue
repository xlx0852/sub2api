<template>
  <div class="card p-4">
        ...
        >
          <button
            ...
            :class="source === 'inbound'
              ? 'bg-white text-gray-900  dark:bg-dark-700 dark:text-white'
    ...
    <div v-else-if="displayEndpointStats.length > 0 && chartData" class="flex min-w-0 flex-col items-center gap-4 sm:flex-row sm:gap-6">
