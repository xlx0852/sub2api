  ...
  <AppLayout>
      ...
      <template #filters>
        <div class="flex flex-col gap-3">
          ...
          <div
            ...
            class="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-gray-200 bg-white px-3 py-2  dark:border-dark-700 dark:bg-dark-800"
          >
    ...
    <Teleport to="body">
      <div
        ...
        class="batch-prompt-popover fixed z-[9999] rounded-lg border border-gray-200 bg-white p-3 text-sm text-gray-800 shadow-lg ring-1 ring-black/5 dark:border-dark-700 dark:bg-dark-900 dark:text-gray-100 dark:ring-white/10"
