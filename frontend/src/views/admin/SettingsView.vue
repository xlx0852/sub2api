    ...
    <div class="settings-page mx-auto w-full max-w-[1440px] space-y-5 px-1 pb-8 sm:px-0">
      ...
      <form v-else @submit.prevent="saveSettings" class="settings-form space-y-5" novalidate>
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
            ...
            <div class="space-y-5 p-6">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  class="input w-full font-mono text-sm"
                  :placeholder="form.openai_codex_client_version_synced || '0.146.0'"
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{
                    t(
                  ...
                  <span v-if="form.openai_codex_client_version_synced" class="ml-1">
                    ({{ t("admin.settings.gatewayForwarding.openaiCodexClientVersionSynced") }}:
          ...
          >
            <div
              class="mx-4 w-full max-w-lg rounded-xl bg-white p-6 shadow-lg dark:bg-dark-800"
            >
              <h3
        ...
        >
          <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-lg dark:bg-dark-900">
...
const form = reactive<SettingsForm>({
  ...
  fallback_model_antigravity: "gemini-3.1-pro-high",
...
.settings-tab-active {
  @apply border-primary-200/80 bg-white text-primary-700 dark:border-primary-400/30 dark:bg-dark-700/95 dark:text-primary-200;
}
