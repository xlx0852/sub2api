  ...
  <AppLayout>
    ...
    <Teleport to="body">
      <div v-if="showGenerateDialog" class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div
          class="relative z-10 w-full max-w-md rounded-xl bg-white p-6 shadow-lg dark:bg-dark-800"
        >
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div
          class="relative z-10 w-full max-w-lg rounded-xl bg-white p-6 shadow-lg dark:bg-dark-800"
        >
    ...
    <Teleport to="body">
      <div v-if="showResultDialog" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative z-10 w-full max-w-lg rounded-xl bg-white shadow-lg dark:bg-dark-800">
          <!-- Header -->
          <div
