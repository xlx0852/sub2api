    ...
    <div class="space-y-6">
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between">
          <h2 class="text-base font-semibold text-gray-900 dark:text-white">{{ t('nav.paymentDashboard') }}</h2>
          <div class="flex items-center gap-2">
            ...
            <button @click="loadDashboard" :disabled="dashboardLoading" class="btn btn-secondary" :title="t('common.refresh')">
      ...
      <div class="space-y-4 border-t border-gray-200 pt-6 dark:border-dark-700">
        <h2 class="text-base font-semibold text-gray-900 dark:text-white">{{ t('nav.orderManagement') }}</h2>
        <!-- Filters -->
        <div class="card p-4">
...
import type { PaymentOrder, DashboardStats } from '@/types/payment'
