export default {
  ...
  usage: {
    ...
    lunaPriceAdjustedNote: '❗ 售价已叠加带宽 · 标价×4',
  ...
  channelStatus: {
    myGroupsTitle: '我的分组可用性',
    myGroupsSubtitle: '按你实际使用的分组展示（usage 成功 + 网关失败），非主动探测',
    myGroupsEmpty: '你还没有绑定任何分组，暂无可用性数据',
    last24h: '近 24 小时',
    last7d: '近 7 天',
