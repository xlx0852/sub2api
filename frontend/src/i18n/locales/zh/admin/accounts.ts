export default {
    accounts: {
      ...
      trash: {
        ...
        bannedOnly: '仅已封禁',
        empty: '回收站为空',
        emptyDescription: '已删除和被封禁的账号会显示在这里。',
        restore: '恢复',
        restoreSuccess: '账号已恢复',
        restoreFailed: '恢复账号失败',
        restoreConfirm: "确定要恢复账号 '{name}' 吗？",
        badgeDeleted: '已删除',
        badgeBanned: '已封禁',
        hint: '回收站中的账号不会出现在正常列表，也不会参与调度。'
      },
      allGroups: '全部分组',
      ...
      editTabs: {
        ...
        advanced: '高级设置',
        cost: '成本配置',
        basicHint: '基础信息与调度。卖价在售价策略；按模型选号在分组路由；上游改名在「模型」Tab。',
        modelsHint: '【供给·出站】本号上游模型映射/白名单。不是售价，也不是分组选号。',
        routingHint: '请求头/路由相关出站覆盖（账号级）。',
        advancedHint: '高级账号选项。',
        costHint: '账号计费倍率等账号侧成本。用户卖价不在这里。',
        costFooterHint: '订阅周期/封号在本页直接保存；账号倍率请点更新账号'
      },
      cannotEnableSchedulableBanned: '已在成本配置中结算封号的账号不能开启调度，请先撤销封号或从回收站恢复',
      bulkSchedulableSkippedBanned: '已跳过 {count} 个不可开启调度的账号',
      ...
      usageDetails: {
        ...
        diagnostics: '数据诊断',
        diagnosticsHint: '展示额度来源、更新时间、最近错误，以及定时连通性测试日志。',
        scheduledTests: '定时测试',
        scheduledTestsHint: '展示该账号最近一次定时连通性检查结果；支持自动开启与多模型升级探测。',
        scheduledTestsManageHint: '在此管理诊断计划：模型、调度、启用与自动恢复。',
        scheduledTestsLoading: '正在加载定时测试日志…',
        scheduledTestsEmpty: '暂无定时测试计划',
        scheduledTestsNoResults: '暂无执行记录',
        scheduledTestsHistory: '历史结果',
        scheduledTestsAvailability: '近期可用性',
        scheduledTestsShowing: '显示最近 {count} 条（最多保留 {max} 条）',
        diagnosticsOn: '已开启',
        diagnosticsOff: '未开启',
        diagnosticsPlans: '{enabled}/{total} 计划',
        scheduledTestsLoadFailed: '定时测试日志加载失败',
        scheduledTestsPlan: '计划',
        scheduledTestsCron: '调度',
        scheduledTestsNextRun: '下次执行',
        scheduledTestsLastRun: '上次执行',
        scheduledTestsLatency: '耗时',
        scheduledTestsSuccess: '成功',
        scheduledTestsFailed: '失败',
        scheduledTestsRunning: '执行中',
        scheduledTestsDisabled: '已停用',
        scheduledTestsResponse: '响应摘要',
        scheduledTestsError: '错误信息',
        scheduledTestsRefresh: '刷新',
        scheduledTestsEnable: '开启自动诊断',
        scheduledTestsEnabling: '正在开启…',
        scheduledTestsEnabled: '已开启自动诊断',
        scheduledTestsRunHint: '单个模型失败会自动升级尝试其他模型；全部失败后临时降权账号。',
        scheduledTestsUpgraded: '升级成功',
        scheduledTestsModelUsed: '使用模型',
        scheduledTestsBaseModel: '计划模型',
        scheduledTestsFailedChain: '失败链路',
        scheduledTestsAttemptCount: '失败 {count} 次后升级',
        scheduledTestsReply: '模型回复',
        scheduledTestsRawError: '原始错误',
        scheduledTestsAllFailed: '全部模型失败',
        scheduledTestsErrorSummary: '错误摘要',
        scheduledTestsTriedModels: '已尝试模型',

        updatedAtLabel: '更新于 {time}',
        refreshStats: '刷新统计',
        noUsageData: '暂无用量数据',
        ...
        last7Days: '近 7 天',
        last30Days: '近 30 天',
        rollingDays: '滚动 {count} 天',
        requestsUnit: '次请求',
        avgLatency: '平均耗时',
        p90Latency: 'P90 耗时',
        avgFirstToken: '首 Token 平均',
        connectionReuse: '连接复用率',
        queueWait: '队列等待',
        payload: '平均请求体',
        preflightFailures: '预检失败 {count}',
        accountStatus: '账号状态',
        dataSource: '额度来源',
        lastUpdated: '最后更新',
        responseStatus: '响应状态',
        ...
        statusExhausted: '额度已满',
        statusNeedsReauth: '需要授权',
      ...
      modelRestriction: '模型限制 / 映射（账号供给）',
      modelWhitelist: '模型白名单',
      modelMapping: '模型映射',
      selectAllowedModels: '选择允许的模型。留空则支持所有模型。',
      mapRequestModels: '上游模型映射（本号出站改名/白名单）。左：请求模型；右：发往上游的实际模型。',
      ...
      expiresAtFollowsCostCycle: '订阅账号过期时间跟随成本周期（starts_at + period_days；封号则为结算时间）',
      expiresAtFollowsCostCycleShort: '跟随成本周期',
      rateMultiplierCostHint: '账号计费倍率，影响利润与成本核算',
      upstreamBilling: {
        autoProbe: '自动探测上游声明倍率',
        autoProbeHint: '启用后按全局周期刷新上游声明的计费倍率；此开关本身不会修改账号倍率。',
        syncRate: '同步上游声明倍率',
        syncRateHint:
          '成功探测后自动更新账号计费倍率（同步的是不含高峰的基准倍率）；探测失败或声明超出允许范围时保持不变。开启本项会同时打开「自动探测上游声明倍率」。',
      ...
      oauth: {
        ...
        openai: {
          ...
          mobileRefreshTokenAuth: 'Mobile Refresh Token 授权',
