export default {
    ...
    channels: {
      ...
      pricingSummaryHint: '官方基准 × 渠道售价覆盖 × 分组倍率 = 用户实扣；账号成本默认跟官方基准',
      noChannelsYet: '暂无渠道',
      ...
      form: {
        ...
        billingFlowDesc: '官方基准价 → 渠道售价（可 ×N 加价）→ × 分组倍率 → 用户实扣',
        billingFlowCostNote: '账号成本默认跟官方基准；仅在本页「账号成本」规则/开关中覆盖，不会被售价 ×N 抬高。',
