export default {
    ...
    groups: {
      ...
      pricing: {
        ...
        billingFlowCostNote: '账号成本默认跟官方基准；不会被售价 ×N 抬高。',
        currentSource: '当前售价来源',
        sourceOfficial: '跟官方基准',
        sourcePolicy: '售价策略',
        sourcePolicyInactive: '策略未生效',
        sourcePolicyNameInactive: '{name}（未生效）',
        inactivePolicy: '策略已停用',
        groupRate: '分组倍率 {rate}x',
        officialOnlyTitle: '当前跟官方基准',
        officialOnlyDesc: '未绑定有效售价策略时，用户单价 = 官方基准 × 分组倍率。配置 luna 等加价请绑定售价策略。',
        selectPolicy: '售价策略',
        selectPolicyPlaceholder: '选择售价策略或跟官方',
        ...
        noModelOverrides: '策略已绑定，但尚未配置模型售价条目（命中时仍回退官方）。',
        noPolicyModels: '未绑定策略，无售价覆盖条目。',
        colModel: '模型',
        colOfficial: '官方',
        colSell: '售价',
        colSource: '来源',
