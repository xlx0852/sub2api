export default {
    accounts: {
      ...
      editTabs: {
        ...
        advanced: 'Advanced',
        cost: 'Cost',
        basicHint: 'Identity and scheduling. Sell prices are on Sell-Price Policies; pick-by-model is Group routing; upstream rename is the Models tab.',
        modelsHint: '[Supply / outbound] Per-account upstream mapping/whitelist. Not sell price, not group account-picking.',
        routingHint: 'Outbound header/routing overrides (account-level).',
        advancedHint: 'Advanced account options.',
        costHint: 'Account billing multiplier / account-side cost. User sell price is not configured here.',
      ...
      modelRestriction: 'Model restriction / mapping (account supply)',
      modelWhitelist: 'Model Whitelist',
      modelMapping: 'Model Mapping',
      selectAllowedModels: 'Select allowed models. Leave empty to support all models.',
      mapRequestModels:
        'Upstream model mapping (per-account rename/whitelist). Left: request model; right: upstream model.',
      ...
      usageDetails: {
        ...
        diagnostics: 'Diagnostics',
        diagnosticsHint: 'Quota source, freshness, latest errors, and scheduled connectivity test logs.',
        scheduledTests: 'Scheduled tests',
        scheduledTestsHint: 'Recent connectivity checks for this account, with auto-enable and multi-model upgrade probes.',
        scheduledTestsManageHint: 'Manage diagnostics plans here: model, schedule, enablement, and auto-recover.',
        scheduledTestsLoading: 'Loading scheduled test logs…',
        ...
        diagnosticsOn: 'On',
        diagnosticsOff: 'Off',
        diagnosticsPlans: '{enabled}/{total} plans',
        scheduledTestsLoadFailed: 'Failed to load scheduled test logs',
        scheduledTestsPlan: 'Plan',
        scheduledTestsCron: 'Schedule',
        scheduledTestsNextRun: 'Next run',
        scheduledTestsLastRun: 'Last run',
        scheduledTestsLatency: 'Latency',
        scheduledTestsSuccess: 'Success',
        scheduledTestsFailed: 'Failed',
        scheduledTestsRunning: 'Running',
        scheduledTestsDisabled: 'Disabled',
        scheduledTestsResponse: 'Response',
        scheduledTestsError: 'Error',
        scheduledTestsRefresh: 'Refresh',
        scheduledTestsEnable: 'Enable auto diagnostics',
        scheduledTestsEnabling: 'Enabling…',
        scheduledTestsEnabled: 'Auto diagnostics enabled',
        scheduledTestsRunHint: 'If one model fails, diagnostics upgrades to other models; all failures temporarily demote the account.',
        scheduledTestsUpgraded: 'Upgraded',
        scheduledTestsModelUsed: 'Model used',
        scheduledTestsBaseModel: 'Plan model',
        scheduledTestsFailedChain: 'Failed chain',
        scheduledTestsAttemptCount: 'Upgraded after {count} failure(s)',
        scheduledTestsReply: 'Reply',
        scheduledTestsRawError: 'Raw error',
        scheduledTestsAllFailed: 'All models failed',
        scheduledTestsErrorSummary: 'Error summary',
        scheduledTestsTriedModels: 'Tried models',
        ...
        rollingDays: 'Rolling {count} days',
        requestsUnit: 'requests',
        avgLatency: 'Average latency',
        p90Latency: 'P90 latency',
        avgFirstToken: 'Average first token',
        connectionReuse: 'Connection reuse',
        queueWait: 'Queue wait',
        payload: 'Average payload',
        preflightFailures: '{count} preflight failures',
        accountStatus: 'Account status',
        dataSource: 'Quota source',
        lastUpdated: 'Last updated',
        responseStatus: 'Response status',
        lastError: 'Latest error',
        sourceActive: 'Active query',
        sourcePassive: 'Passive sample',
        sourceLocal: 'Local statistics',
        statusNormal: 'Normal',
        statusNearLimit: 'Near limit',
        statusExhausted: 'Quota exhausted',
        statusNeedsReauth: 'Reauthorization required',
