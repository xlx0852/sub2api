export default {
    accounts: {
      ...
      usageWindow: {
        ...
        grokWeekly: 'Wk',
        grokMonthly: 'Mo$',
        grokUnknown: 'Grok quota unknown — click Query quota to check official billing, or wait for rate-limit headers.',
        grokRetryAfter: 'Retry after {time}',
        grokProbe: 'Query quota',
