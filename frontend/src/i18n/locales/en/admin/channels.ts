export default {
    ...
    channels: {
      ...
      sharedPolicyTitle: '⚠️ Shared policy (affects multiple groups)',
      sharedPolicyDesc: 'This policy is also bound to: {names}. Saving here updates sell prices for ALL of them.',
      sharedPolicyHint: 'Want to change only this group? Split to a dedicated policy first.',
      splitDedicated: 'Split to dedicated',
      splitConfirm: 'Create a dedicated policy for this group from the current prices and bind it, so other groups are no longer affected. Continue?',
      splitSuccess: 'Split to a dedicated policy for this group',
      splitError: 'Split failed',
