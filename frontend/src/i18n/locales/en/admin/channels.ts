export default {
    ...
    channels: {
      ...
      pricingSummaryHint: 'Official base × channel sell override × group rate = user charge; account cost defaults to official base',
      ...
      form: {
        ...
        billingFlowDesc: 'Official base → channel sell price (optional ×N) → × group rate → user charge',
