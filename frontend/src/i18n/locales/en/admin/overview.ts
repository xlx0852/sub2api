export default {
    ...
    groups: {
      ...
      editTabs: {
        ...
        basicHint: 'Plan identity and visibility. Bind sell-price policies under Rate & Pricing — do not rename models here.',
        rateHint: 'Group rate multiplies user charge; absolute sell prices are on Sell-Price Policies (bind via Pricing). Account COGS is on Accounts.',
        routingHint: '[Pick accounts] Prefer which accounts handle a request model. Upstream rename/whitelist is Account mapping.',
        advancedHint: 'Platform-specific options (messages dispatch, models list, client restrictions, etc.).',
        availabilityHint: 'Real-traffic availability for this group (usage successes + gateway failures), not active probing.',
        rateBannerTitle: 'Sell prices are not edited in this form',
      ...
      pricing: {
        ...
        billingFlowCostNote: 'Account cost defaults to official base; sell ×N does not raise COGS.',
        currentSource: 'Current sell source',
        sourceOfficial: 'Official base',
        sourcePolicy: 'Sell-price policy',
        sourcePolicyInactive: 'Policy inactive',
        sourcePolicyNameInactive: '{name} (inactive)',
        inactivePolicy: 'Policy disabled',
        groupRate: 'Group rate {rate}x',
        officialOnlyTitle: 'Following official base',
        officialOnlyDesc: 'Without an active sell-price policy, user unit price = official × group rate. Bind a policy for markups like luna ×4.',
        selectPolicy: 'Sell-price policy',
        selectPolicyPlaceholder: 'Choose a policy or follow official',
        ...
        noModelOverrides: 'Policy bound, but no model sell rows yet (falls back to official on miss).',
        noPolicyModels: 'No policy bound — no sell overrides.',
        colModel: 'Model',
        colOfficial: 'Official',
        colSell: 'Sell',
        colSource: 'Source',
        colEffective: 'User unit',
        statusDisabled: 'disabled',
        loadError: 'Failed to load group pricing',
        bindSuccess: 'Sell-price policy updated',
        bindError: 'Failed to update sell-price policy'
      },
      availability: {
        title: 'Availability',
        sourceTag: 'Real traffic',
        sourceHint: 'From real requests: usage successes + gateway failures; not active probing',
        last24h: 'Last 24h',
        last7d: 'Last 7d',
        samples: 'ok {ok} / failed {fail}',
        timeline24h: '24h timeline (10m buckets)',
