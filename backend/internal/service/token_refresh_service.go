...
func (s *TokenRefreshService) RegisterKimiOAuthService(oauthService *KimiOAuthService) {
	if s == nil || oauthService == nil {
		return
	}
	refresher := NewKimiTokenRefresher(oauthService)
