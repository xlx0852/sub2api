...
func TestBillingService_GPT56CacheWritePricingUsesOfficialMultiplier(t *testing.T) {
	tests := []struct {
		...
		{model: "gpt-5.6-luna", input: 0.8e-6, inputPriority: 1.6e-6, output: 4.8e-6, outputPriority: 9.6e-6, cacheRead: 0.08e-6, cacheReadPriority: 0.16e-6},
	}
...
func TestBillingService_GPT56UsesLongContextPricingAcrossModelsAndTiers(t *testing.T) {
	models := []struct {
		...
		{name: "gpt-5.6-luna", input: 0.8e-6, cached: 0.08e-6, cacheWrite: 1e-6, output: 4.8e-6},
	}
	tiers := []struct {
		name       string
		priceScale float64
...
func TestPricingService_BareGPT56AliasDeterministicallyUsesSol(t *testing.T) {
	pricingSvc := &PricingService{pricingData: map[string]*LiteLLMModelPricing{
		...
		"gpt-5.6-luna":  {InputCostPerToken: 0.8e-6},
...
func TestDefaultPricingIncludesOfficialGPT56Rates(t *testing.T) {
	...
	tests := []struct {
		...
		{model: "gpt-5.6-luna", input: 0.8e-6, cached: 0.08e-6, cacheWrite: 1e-6, output: 4.8e-6, inputPriority: 1.6e-6, cachedPriority: 0.16e-6, cacheWritePriority: 2e-6, outputPriority: 9.6e-6},
	}
	for _, tt := range tests {
		t.Run(tt.model, func(t *testing.T) {
...
func TestGPT56DedicatedFallbacksUseOfficialRates(t *testing.T) {
	tests := []struct {
		...
		{model: "gpt-5.6-luna", input: 0.8e-6, cached: 0.08e-6, cacheWrite: 1e-6, output: 4.8e-6},
	}
