...
func TestGetModelPricing_OpenAIGPT54FallbackRetainedForHistoricalBilling(t *testing.T) {
	svc := newTestBillingService()
...
func TestGetModelPricing_OpenAIGPT54MiniFallbackRetainedForHistoricalBilling(t *testing.T) {
	svc := newTestBillingService()
...
func TestGetModelPricing_OpenAIGPT54NanoFallbackRetainedForHistoricalBilling(t *testing.T) {
	svc := newTestBillingService()
...
func TestCalculateCost_OpenAIGPT55LongContextAppliesWholeSessionMultipliers(t *testing.T) {
	svc := newTestBillingService()
...
func TestCalculateCost_OpenAIGPT54LongContextRetainedForHistoricalBilling(t *testing.T) {
	svc := newTestBillingService()
