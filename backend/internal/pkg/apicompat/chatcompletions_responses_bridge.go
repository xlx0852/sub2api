...
func ResponsesToChatCompletionsRequest(req *ResponsesRequest) (*ChatCompletionsRequest, error) {
	...
	if len(effectiveTools) > 0 {
		out.Tools = responsesToolsToChatTools(effectiveTools)
	}
...
// EffectiveResponsesTools returns all client-executable tools declared by a
// Responses request. Newer Codex clients place runtime tools in an input item
// shaped as {"type":"additional_tools","tools":[...]}.
