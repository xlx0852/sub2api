...
// SetUpstreamBillingProbeService injects the probe service after construction
// (keeps NewAccountHandler's parameter list stable).
func (h *AccountHandler) SetUpstreamBillingProbeService(svc *service.UpstreamBillingProbeService) {
	h.upstreamBillingProbe = svc
}
