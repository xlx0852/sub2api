...
// APIKeyAuthWithSubscriptionGoogle keeps its historical name/signature for route compatibility,
// but user subscription quota billing has retired and all requests use balance enforcement.
