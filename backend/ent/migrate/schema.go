...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "ws_conn_reused", Type: field.TypeBool, Nullable: true},
		{Name: "ws_preflight_fail_count", Type: field.TypeInt, Nullable: true},
		{Name: "ws_conn_pick_ms", Type: field.TypeInt, Nullable: true},
		{Name: "ws_payload_bytes", Type: field.TypeInt64, Nullable: true},
		{Name: "ws_event_count", Type: field.TypeInt, Nullable: true},
		{Name: "ws_queue_wait_ms", Type: field.TypeInt, Nullable: true},
